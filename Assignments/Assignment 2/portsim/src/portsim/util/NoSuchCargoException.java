...
public class NoSuchCargoException extends Exception {
    ...
    /**
     * Constructs a {@link NoSuchCargoException} that contains a helpful detail message explaining
     * why
    ...
    /**
     * Constructs a {@link NoSuchCargoException} that stores the underlying cause of the exception.
     *
    ...
    /**
     * Constructs a {@link NoSuchCargoException} that contains a helpful detail message
