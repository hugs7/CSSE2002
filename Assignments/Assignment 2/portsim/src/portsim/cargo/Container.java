...
public class Container extends Cargo {
    ...
    public boolean equals(Object o) {
        return super.equals(o)
                && type.equals(((Container) o).type);
    }

    /**
     * Returns the hash code of this Container.
     * Two Containers should only have the same hashcode if their .equals() method returns true.
     * @return hash code of this Container.
     */
    @Override
    public int hashCode() {
        return (int) Math.round(super.hashCode()
                + Math.pow(5, this.getType().hashCode()));
    }
    ...
    /**
     * Returns the machine-readable representation of this Container.
     * The format of the string to return is
