...
public class ContainerShip extends Ship {
     ...
     * <ol>
     *     <li>{@link Quay} must be a {@link ContainerQuay}.</li>
     ...
     * <ol>
     *     <li>The cargo given is a {@link Container}</li>
    ...
    /**
     * Return true if and only if this {@link ContainerShip} is equal to the other given
     * {@link ContainerShip}.
     * <p>
     * For two {@code ContainerShips} to be equal, they must have the same name, flag, origin flag,
    ...
    /**
     * Returns the hash code of this {@link ContainerShip},
     * <p>
     * Two {@code ContainerShips} that are equal according to
     * {@link ContainerShip#equals(Object)} method should have the same hash code.
     *
     * @return hash code of this {@link ContainerShip}
     */
    @Override
    public int hashCode() {
        return Math.round(super.hashCode() * containerCapacity);
    }

    /**
     * Returns the human-readable string representation of this {@link ContainerShip}.
     * <p>
     ...
     * For example:
     *
     * <pre>ContainerShip Evergreen from Australia [BRAVO] carrying 3 containers</pre>
     *
     * @return string representation of this {@link ContainerShip}
     * @ass1
     */
    @Override
    ...
    /**
     * Returns the machine-readable string representation of this {@link ContainerShip}.
     * <p>
     * The format of the string to return is
     ...
     *     <li>{@code ID1,ID2,...} are the IDs of the cargo on the ship separated with a comma or
     *     an empty string "" if there are none</li>
     * </ul>
     *
    ...
    public String encode() {
        ...
        for (Cargo cargo : getCargo()) {
            cargoString.append(cargo.getId());
            cargoString.append(",");
        }
        cargoString.replace(-1, 0, "]");
